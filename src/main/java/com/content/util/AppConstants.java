...
public class AppConstants {
	...
	public static final String PRIMARY_MEDIA_FILE_PARAM = "primary_MediaPath";
	public static final String PREVIEW_FILE_PARAM = "preview_Path";
	public static final String BANNER_FILE_PARAM = "banner_Path";
	public static final String ADDTIONAL_MEDIA_FILE_PARAM = "additional_Media_Path";
	public static final String TUMBNAIL_FILE_PARAM = "tumbnail_Path";
